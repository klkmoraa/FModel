...
| 8 | BLK-001 | P2 | Sustituir remapeos JSON por remapeo tipado | Cerrada | DAT-003 | [Bloques](./03-bloques-referencias.md#blk-001--centralizar-el-remapeo-tipado-de-identificadores) |
| 9 | DAT-004 | P2 | Hacer visibles los fallos de persistencia y cuota | Cerrada | DAT-001 | [Integridad](./01-integridad-archivos.md#dat-004--informar-fallos-de-persistencia-y-cuota) |
| 10 | WRK-001 | P2 | Cancelar y transferir operaciones pesadas | Cerrada | DAT-003 | [Rendimiento/PWA](./05-rendimiento-pwa.md#wrk-001--cancelar-y-transferir-operaciones-pesadas) |
| 11 | TST-002 | P2 | Medir cobertura y fijar umbrales | Cerrada | — | [Calidad](./06-calidad-arquitectura-pruebas.md#tst-002--medir-cobertura-y-fijar-umbrales) |
| 12 | GEO-001 | P2 | Probar invariantes geométricas y entradas degeneradas | Cerrada | TST-002 | [Geometría](./02-geometria-comandos.md#geo-001--probar-invariantes-y-geometría-degenerada) |
| 13 | BLK-002 | P2 | Validar paquetes antes de instalar la biblioteca | Cerrada | DAT-003, BLK-001 | [Bloques](./03-bloques-referencias.md#blk-002--validar-paquetes-de-biblioteca-antes-de-instalarlos) |
| 14 | XRF-001 | P2 | Verificar portabilidad de referencias y recursos | Cerrada | DAT-003, BLK-001 | [Bloques](./03-bloques-referencias.md#xrf-001--verificar-portabilidad-completa-de-referencias-y-recursos) |
...
| 16 | UI-001 | P2 | Auditoría de accesibilidad y teclado | Cerrada | TST-001 | [Interfaz](./04-interfaz-accesibilidad.md#ui-001--cerrar-la-brecha-de-accesibilidad-y-teclado) |
...
| 18 | CI-001 | P2 | Unificar toolchain y comando de verificación | Cerrada | — | [Calidad](./06-calidad-arquitectura-pruebas.md#ci-001--unificar-toolchain-lint-y-verificación-local) |
| 19 | CMD-001 | P2 | Probar comportamiento de comandos disponibles | Cerrada | TST-001, TST-002 | [Geometría](./02-geometria-comandos.md#cmd-001--pruebas-de-comportamiento-para-comandos-declarados-disponibles) |
| 20 | DOC-002 | P2 | Vincular funciones disponibles con evidencia | Cerrada | CMD-001, TST-001 | [Distribución](./07-distribucion-documentacion.md#doc-002--vincular-el-estado-disponible-con-evidencia) |
...
| 22 | ARC-001 | P3 | Dividir módulos monolíticos por responsabilidad | Cerrada | TST-002 | [Calidad](./06-calidad-arquitectura-pruebas.md#arc-001--dividir-módulos-monolíticos-con-pruebas-de-caracterización) |
| 23 | UI-002 | P3 | Validar interacción táctil en dispositivos reales | Cerrada | TST-001, UI-001 | [Interfaz](./04-interfaz-accesibilidad.md#ui-002--validar-la-experiencia-táctil-en-dispositivos-reales) |
| 24 | UI-003 | P3 | Estandarizar progreso, error y cancelación | Cerrada | WRK-001, DAT-004 | [Interfaz](./04-interfaz-accesibilidad.md#ui-003--estandarizar-estados-de-carga-error-y-operación-larga) |
...
| 28 | BLK-003 | P2 | Integrar una colección ampliada de bloques CC0 en formato FModel | Cerrada | — | [Bloques](./03-bloques-referencias.md#blk-003--integrar-una-colección-ampliada-cc0-en-formato-fmodel) |
