...
export const FEATURES: Feature[] = [
  ...
  F('Bloques', 'Blocks', 'Definiciones, inserción con autoescala, atributos y extracción', 'Definitions, insertion with unit scaling, attributes and extraction', 'available', ['BLOCK', 'INSERT', 'ATTDEF', 'ATTEDIT', 'DATAEXTRACTION']),
  F('Bloques', 'Blocks', 'Biblioteca por categorías con etiquetas, importación desde DXF (bloques o dibujo entero) y bibliotecas compartibles .fmodellib', 'Categorized library with tags, import from DXF (blocks or whole drawing) and shareable .fmodellib libraries', 'available', ['LIBRARYIMPORT', 'LIBRARYEXPORT', 'WBLOCK']),
  ...
  F('Intercambio', 'Interchange', 'Lectura DWG con LibreDWG (abrir e importar a la biblioteca)', 'DWG reading with LibreDWG (open and import to the library)', 'experimental', ['OPEN', 'LIBRARYIMPORT'], ['Probada con DWG de AutoCAD 2000 y 2018 frente a su DXF equivalente. El lector (WebAssembly, ~10 MB) se descarga al primer uso. LibreDWG es GPL-3.0: uso privado; publicar FModel obligaría a revisar la licencia.', 'Tested with AutoCAD 2000 and 2018 DWG against their equivalent DXF. The reader (WebAssembly, ~10 MB) downloads on first use. LibreDWG is GPL-3.0: private use; publishing FModel would require a license review.']),
  F('Intercambio', 'Interchange', 'Escritura DWG', 'DWG writing', 'not-committed', undefined, ['LibreDWG no escribe DWG de forma fiable y no se simula: exporta DXF.', 'LibreDWG does not write DWG reliably and it is not simulated: export DXF.']),
  F('Referencias', 'References', 'Dibujos referenciados (enlazar/superponer), recarga, descarga, apertura, unión, ruta, detección de ciclos', 'Referenced drawings (attach/overlay), reload, unload, open, bind, repath, cycle detection', 'available', ['XATTACH', 'XREFMANAGER', 'XRELOAD', 'XOPEN', 'XBIND', 'XREPATH']),
  ...
  F('Productividad', 'Productivity', 'Paleta de comandos, alias y atajos configurables, repetir último, favoritos, propiedades rápidas, historial de comandos y ayuda contextual', 'Command palette, configurable aliases and shortcuts, repeat last, favorites, quick properties, command history and contextual help', 'available', ['OPTIONS', 'HELP', 'QUICKPROPERTIES', 'TEXTSCR']),
