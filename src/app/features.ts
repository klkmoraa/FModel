...
export const FEATURES: Feature[] = [
  ...
  F('Lienzo', 'Canvas', 'Uso táctil: encuadre, pellizco, pulsación larga, lupa al situar puntos y paneles en hoja móvil', 'Touch use: pan, pinch, long press, magnifier while placing points and mobile sheet panels', 'experimental', undefined, ['El dedo sitúa el punto con lupa y apertura de referencia ampliada; probado con eventos de puntero, no en dispositivos reales. En teléfono el dibujo detallado es limitado por el tamaño de pantalla.', 'The finger places points with a magnifier and a wider snap aperture; tested with pointer events, not on real devices. Detailed drafting on phones is limited by screen size.']),
